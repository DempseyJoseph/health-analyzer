...
// Support both hardhat vars and environment variables (PowerShell $env: syntax)
...
const config: HardhatUserConfig = {
  ...
  typechain: {
    outDir: "types",
    target: "ethers-v6",
    dontOverrideCompile: true, // Disable automatic typechain generation during compile
  },
};
